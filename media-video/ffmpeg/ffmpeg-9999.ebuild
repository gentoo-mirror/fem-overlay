...
BROADCAST_PATCHES_P="ffmpeg-patches-v${BROADCAST_PATCHES_PV}"
...
SRC_URI="
	...
	https://gitlab.fem-net.de/broadcast/ffmpeg-patches/-/archive/v${BROADCAST_PATCHES_PV}/${BROADCAST_PATCHES_P}.tar.bz2
"
if [ "${PV#9999}" != "${PV}" ] ; then
	src_unpack() {
		git-r3_src_unpack
		unpack "${BROADCAST_PATCHES_P}.tar.bz2"
	}
