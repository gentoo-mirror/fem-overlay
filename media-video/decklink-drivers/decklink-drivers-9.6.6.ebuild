...
MY_PV=${PV/_rc*}
MY_RC=${PV/_}"a28"
SRC_URI="http://www.blackmagicdesign.com/media/4976383/Blackmagic_Desktop_Video_Linux_${MY_PV}.tar.gz
	http://www.blackmagicdesign.com/media/4976351/Blackmagic_DeckLink_SDK_${MY_PV}.zip"
