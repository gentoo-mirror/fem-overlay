...
UNPACKED_DIR="desktopvideo-10.5.2a5-x86_64"
...
MODULE_NAMES="blackmagic(misc:${S}/usr/src/blackmagic-10.5.2a5)
blackmagic-io(misc:${S}/usr/src/blackmagic-io-10.5.2a5)"
