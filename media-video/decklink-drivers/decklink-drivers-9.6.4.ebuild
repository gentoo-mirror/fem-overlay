...
MY_PV=${PV/_rc*}
MY_RC=${PV/_}"a24"
SRC_URI="http://www.blackmagicdesign.com/media/4819889/Blackmagic_Desktop_Video_Linux_${MY_PV}.tar.gz
	http://www.blackmagicdesign.com/media/4820025/Blackmagic_DeckLink_SDK_${MY_PV}.zip"
