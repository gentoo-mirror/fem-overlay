...
# Custom: auth_ldap (https://github.com/kvspb/nginx-auth-ldap, BSD license)
HTTP_AUTH_LDAP_MODULE_PV="0.1"
HTTP_AUTH_LDAP_MODULE_P="nginx-auth-ldap-master"
HTTP_AUTH_LDAP_MODULE_URI="https://github.com/kvspb/nginx-auth-ldap/archive/master.tar.gz"
HTTP_AUTH_LDAP_MODULE_WD="${WORKDIR}/nginx-auth-ldap-master"
#HTTP_AUTH_LDAP_MODULE_P="nginx-auth-ldap-${HTTP_AUTH_LDAP_MODULE_PV}"
#HTTP_AUTH_LDAP_MODULE_URI="https://github.com/kvspb/nginx-auth-ldap/archive/v${HTTP_AUTH_LDAP_MODULE_PV}.tar.gz"
