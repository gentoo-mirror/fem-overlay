...
# http_auth_ldap (https://github.com/kvspb/nginx-auth-ldap, BSD license)
HTTP_AUTH_LDAP_MODULE_PV="master"
HTTP_AUTH_LDAP_MODULE_P="nginx-auth-ldap-${HTTP_AUTH_LDAP_MODULE_PV}"
HTTP_AUTH_LDAP_MODULE_URI="https://github.com/kvspb/nginx-auth-ldap/archive/master.zip"
...
SRC_URI="http://nginx.org/download/${P}.tar.gz
	...
	nginx_modules_http_auth_ldap? ( ${HTTP_AUTH_LDAP_MODULE_URI} -> ${HTTP_AUTH_LDAP_MODULE_P}.zip )
