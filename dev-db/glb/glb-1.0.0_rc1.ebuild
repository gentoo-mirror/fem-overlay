...
SRC_URI="http://www.codership.com/files/glb/glb-1.0.0rc1.tar.gz -> glb-${PV}.tar.gz"
...
src_prepare() {
	epatch "${FILESDIR}"/001_ISO_C90_decimal_constant_is_unsigned_only-1.0.0_rc1.patch
}
