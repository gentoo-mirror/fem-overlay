...
# $Header: /var/cvsroot/gentoo-x86/dev-lang/php/php-5.2.13.ebuild,v 1.4 2010/03/23 19:58:31 ranger Exp $
...
src_unpack() {
	...
	# maillog support (http://news.php.net/php.cvs/55496)
	if use maillog ; then
		epatch "${FILESDIR}"/${PN}-5.2.12-maillog.patch
	fi
