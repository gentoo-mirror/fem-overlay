...
# $Id: d0c26c880bc4020006b027a23fe6bf5b586b3737 $
...
EOF
	...
	# Patch gentoo-specific inventory functions
	use inventory && epatch "${FILESDIR}/mk_inventory.linux.patch"
...
src_install() {
	...
	use inventory && doexe plugins/mk_inventory.linux
}
